...
const enigma_db_1 = __importDefault(require("enigma-db"));
const enigmaInstance = new enigma_db_1.default("postgresql://localhost:8000/test1", "postgresql://localhost:8001/test1");
function init() {
